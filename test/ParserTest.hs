...
parserTests = testGroup "Happy-based Tiger parser" [testParserNil, testParserIfThenElse, testParserIfThenIfThenElse, testParserWhileDo, testParserProperForLoop, testParserSubscriptVar, testParserSeq, testParserArray, testParserLetVarDec, testParserLetVarDec2, testParserLetVarDec3,testParserLetRecursiveFuncs, testParserTypeDecs, testParserLetFuncDecl]

testParserNil =
  testCase "parses 'NIL'" $ assertEqual [] (Program NilExp) (happyTokenParse $ alexMonadScanTokens "nil")
--testParserIfNil =
--  testCase "does not parse 'IF NIL'" $ assertEqual [] ("Exception: Parse error: (Line 1, Col 7): TEOF") (happyTokenParseWithPosn $ alexMonadScanTokensWithPosn "if nil")
